...
public class ClassNode extends AbstractAST {
	...
	public String toString() {
		return "{name:" + getName() + ", definition:" + getDefinition() + ", createMethod:" + getCreateMethod()
				+ ", method:" + getMethod() + "}";
	}

	// Modificaciones

	private List<String> createDefinitions = new ArrayList<>();

	public List<String> getCreateDefinition() {
		return createDefinitions;
	}

	public void setCreateDefinitions(String createDefinition) {
		this.createDefinitions.add(createDefinition);
	}
