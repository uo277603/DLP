...
public class ExprBinariaAritmetica extends AbstractExpr {

	public ExprBinariaAritmetica(Expr left, String op, Expr right) {
		this.left = left;
		this.op = op;
		this.right = right;
	...
	public ExprBinariaAritmetica(Object left, Object op, Object right) {
